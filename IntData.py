...
time_step = 5e5 * yr  # Time between each step.
time_run = 0.5 * Gyr  # Total time simulation is run for.
if rewind:
    time_step = - time_step  # Time between each step, running backwards.
    time_run = - time_run  # Total time simulation is run for, backwards.
images = 21  # Total number of images shown. Remember to add 1 to make sure you get the beginning and end image.
...
xg1 = -35 * kpc  # x position of primary galaxy.
yg1 = -120 * kpc  # y position of primary galaxy.
zg1 = 0 * kpc  # y position of primary galaxy.
vxg1 = 0 * km_s  # x velocity of primary galaxy.
vyg1 = 75 * km_s  # 110 * kms # y velocity of primary galaxy.
...
dr1 = 25 * kpc  # Radius of disk if primary galaxy.
no_rings1 = 100  # Number of rings in primary galaxy.
ring_rad1 = dr1 / no_rings1  # Radius of innermost ring from primary galaxy centre.
no_rp1 = 1  # Number of particles in innermost ring of primary galaxy.
...
xg2 = 120 * kpc  # 120 * kpc  # x position of secondary galaxy.
yg2 = 35 * kpc  # 500 * kpc  # y position of secondary galaxy.
zg2 = 0 * kpc  # z position of secondary galaxy.
vxg2 = -115 * km_s  # x velocity of secondary galaxy.
...
M_vir2 = 1.8e12 * sm  # Virial mass of the secondary galaxy's dark matter halo.
